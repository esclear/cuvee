...
// source: cuvee/src/cuvee/sexpr/Scanner.flex
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 19: break;
          case 8:
            { return new Kw(yytext(+1,0));
            }
            // fall through
          case 20: break;
          case 9:
            { return new Id(yytext(+1,-1));
            }
            // fall through
          case 21: break;
          case 10:
            { return new Lit.bin(yytext(+2,0));
            }
            // fall through
          case 22: break;
          case 11:
